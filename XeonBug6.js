...
await XeonBotInc.sendMessage(from, {text: xeonlod[i], edit: key });
        ...
        if (autobio) {
            XeonBotInc.updateProfileStatus(`24/7 Online Bot By KAWAKI-227-0-SOUCIS Sir Bot Owner ${ownername} For more  Hacks Search On Youtube KA-WA-KI`).catch(_ => _)
        }
            ...
            case 'scriptbot':
                XeonBotInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `SCRIPT OF TST-BOT is on YouTube kawaki❤️`,
                            body: `Love You bro 😘`,
                            thumbnailUrl: 'https://i.imgur.com/9riF0Uy.png',
                            sourceUrl: global.link,
                            mediaType: 1,
...
break
case 'kawaki227':
xeonimun(' merci beaucoup davoir utiliser mon bot  ❤️ Dear \n Thanks For using My Bug  Bot \n\n *Do not Forget To support me by subscribe my channel* \n _Youtube Search KA-WA-KI Thanks_ 🙏 😘')
break
            case 'menu':
            case 'help':
            case 'alive':
            case 'bot':
            case 'allmenu':
                let xeonmenuoh = `SALUT CHEF ${pushname}
${xeonytimewisher}
🂷❏❙❘❙❙❘❙❚❙❘❙❙❚❙❘❙❘❙❚❙❘❙❙❚❙❘❙❙❘❙❚❙❘❏🂷
              🃑𝙺𝚊𝚠𝚊𝚔𝚒-227🃑
┠┌─▣𝑻𝑺𝑻-𝑩𝑼𝑮-𝑩𝑶𝑻 💫▣
